...
import MovieAddStores from '../stores/MovieAddStores'
...
export default class AddMovie extends React.Component {
  constructor (props) {
    ...
    this.state = MovieAddStores.getState()
  ...
  componentDidMount () {
    MovieAddStores.listen(this.onChange)
  }

  componentWillUnmount () {
    MovieAddStores.unlisten(this.onChange)
  }
