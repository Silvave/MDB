...
var MovieActions = function () {
  function MovieActions() {
    ...
    this.generateActions('getTopTenMoviesSuccess', 'getTopTenMoviesFail', 'getFiveRecentMovieSuccess', 'getFiveRecentMovieFail', 'emptyTopTenMovies', 'addMovieToTopTen', 'addCommentSuccess', 'addCommentFail', 'addVoteSuccess', 'addVoteFail');
  }
  ...
  _createClass(MovieActions, [{
    ...
    value: function getFiveRecentMovies() {
      ...
      $.ajax(request).done(function (data) {
        return _this.getFiveRecentMovieSuccess(data);
      });
...
},{"../actions/MovieAddActions":35,"../stores/MovieAddStores":68,"../utilities/Helpers":73,"react":"react"}],43:[function(require,module,exports){
'use strict';
  ...
  _createClass(UserProfile, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_UserProfileInfo2.default, { roles: this.state.roles,
          name: this.state.name,
...
var MovieCommentsPanelForm = function (_React$Component) {
  ...
  _createClass(MovieCommentsPanelForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'form',
        { key: this.props.movieId, onSubmit: this.handleSubmit },
        _react2.default.createElement(
          'div',
...
var MovieCard = function (_React$Component) {
  ...
  function MovieCard(props) {
    ...
    _this.toggleVotePanel = _this.toggleVotePanel.bind(_this);
    return _this;
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_MoviePanelsToggle2.default, {
            ...
            toggleVotePanel: this.toggleVotePanel,
...
var MoviePanelsToggle = function (_React$Component2) {
  _inherits(MoviePanelsToggle, _React$Component2);

  function MoviePanelsToggle() {
    _classCallCheck(this, MoviePanelsToggle);

    return _possibleConstructorReturn(this, (MoviePanelsToggle.__proto__ || Object.getPrototypeOf(MoviePanelsToggle)).apply(this, arguments));
  }

  _createClass(MoviePanelsToggle, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
  ...
  return MoviePanelsToggle;
}(_react2.default.Component);

exports.default = MoviePanelsToggle;
    ...
    value: function render() {
      ...
      if (this.props.posterUrl) {
        poster = _react2.default.createElement(
          ...
          _react2.default.createElement("img", { src: this.props.posterUrl, className: "media-object" })
        );
      }
      return poster;
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("img", { src: "/images/user-default.png", alt: "user-image" })
        ),
        _react2.default.createElement(
          "div",
...
var UserRatedMovies = function (_React$Component) {
  ...
  function UserRatedMovies(props) {
    ...
    _this.toggleRatedMovies = _this.toggleRatedMovies.bind(_this);
    return _this;
  }
...
var FormStore = function () {
  ...
  _createClass(FormStore, [{
    ...
    value: function onScoreValidationFail(err) {
      this.scoreValidationState = 'has-error';
...
var MovieAddStores = function () {
  ...
  _createClass(MovieAddStores, [{
    ...
    value: function onHandleGenresChange(e) {
      console.log(e);
      var genresValue = e.target.value;

      if (this.genres.indexOf(genresValue) === -1) {
        this.genres = _Helpers2.default.appendToArray(genresValue, this.genres);
      } else {
        this.genres = _Helpers2.default.removeFromArray(genresValue, this.genres);
      }
...
var MovieStore = function () {
  ...
  _createClass(MovieStore, [{
    key: 'addVoteSuccess',
    value: function addVoteSuccess(data) {
    ...
    value: function onAddCommentSuccess(data) {
      ...
      try {
        for (var _iterator2 = this.topTenMovies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    key: 'onGetFiveRecentMovieSuccess',
    value: function onGetFiveRecentMovieSuccess(data) {
      this.mostRecentMovies = data;
    }
  }, {
    key: 'onGetFiveRecentMovieFail',
    value: function onGetFiveRecentMovieFail() {
  ...
  _createClass(Helpers, null, [{
    ...
    value: function nodesMovieCard(state, props, toggleCommentsPanel, toggleVotePanel) {
      ...
      nodes.panelToggles = _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouter.Link,
          { to: '/movie/' + props.movie._id + '/review/add',
            className: 'btn btn-warning' },
          'Write review'
        )
      );
      ...
      if (props.movie.moviePosterUrl) {
        nodes.poster = _react2.default.createElement('img', { src: props.movie.moviePosterUrl,
          alt: 'movie-poster',
...
},{"../components/sub-components/MovieCommentsPanel":54,"../components/sub-components/MovieVotePanel":58,"react":"react","react-router":"react-router"}],74:[function(require,module,exports){
'use strict';
